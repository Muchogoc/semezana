...
func (uc *UserCreate) check() error {
	...
	if _, ok := uc.mutation.StateAt(); !ok {
		return &ValidationError{Name: "state_at", err: errors.New(`ent: missing required field "User.state_at"`)}
	}
	return nil
}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.StateAt(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeTime,
			Value:  value,
